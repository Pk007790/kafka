 ...
 */
public class MultiThreadInSingleJVMDriver {

    public static final String CONSUMER_GROUP_ID = "multiThreadInSingleJVM";
    ...
    public static Properties getConsumerProps() {
        ...
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, MultithreadInSingleJVM.BOOTSTRAP_SERVER);
    ...
    public static void produceInput(){
        ...
        IntStream.range(0,MAX_RECORDS)
                .forEach(record ->producer.send(new ProducerRecord<String, String>
                        (MultithreadInSingleJVM.INPUT_TOPIC,null,msg[random.nextInt(msg.length)])));//msg[random.nextInt(msg.length)]
